...
export const BOARD_TILES: Record<number, BoardTile> = {
  ...
  32: {
    index: 32,
    label: 'AVR Predictive Forum ★',
    type: 'normal',
    projectKey: 'avrsathishkumar',
    projectName: 'AVR Predictive Forum',
    liveUrl: 'https://www.avrsathishkumar.in/',
    metric: '1,000+ Trained Astrologers',
    story: '🔮 Vedic astrology education & AVRS System portal deployed for 1,000+ practitioners.',
  },
  33: {
    index: 33,
